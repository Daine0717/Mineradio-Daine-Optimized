...
function initIdleGuideCanvas() {
  ...
  window.addEventListener('mineradio-resize-end', resizeIdleGuideCanvas);
  drawIdleGuideFrame();
}

// ============================================================
//  Startup visual guide
// ============================================================
...
function startVisualGuide(opts) {
  ...
  if (!visualGuideResizeBound) {
    ...
    window.addEventListener('mineradio-resize-end', positionVisualGuideStep);
