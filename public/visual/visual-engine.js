...
uniform float uPreset, uMinimalMode, uIntensity, uDepth, uPointScale, uSpeed, uTwist;
...
void main(){
  ...
  // ====================================================
    ...
    if (lane < 0.80) {
      ...
      vAlpha = (0.18 + ridge * 0.78 + pulseLine * highGlow * 0.035 + bassGlow * 0.025) * softMask * (0.96 + transition * 0.02) * mix(1.0, 0.24, uMinimalMode);
    ...
    float minimalLum = dot(vColor, vec3(0.299, 0.587, 0.114));
    vColor = mix(vColor, vec3(minimalLum), uMinimalMode * 0.92);
  }
